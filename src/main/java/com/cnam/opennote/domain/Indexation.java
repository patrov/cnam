...
@NamedQueries({
   //@NamedQuery(name = "Indexation.findAll", query = "SELECT i FROM Indexation i"),
    ...
    @NamedQuery(name = "Indexation.findByContentUid", query = "SELECT i FROM Indexation i WHERE i.contentUid = :contentUid"),
    ...
    @NamedQuery(name = "Indexation.findByContentType", query = "SELECT i FROM Indexation i WHERE i.contentType = :contentType")})
